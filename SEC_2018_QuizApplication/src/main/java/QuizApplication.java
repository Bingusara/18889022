...
public class QuizApplication {
    ...
    public static void main(String[] args) {
        ...
        PluginLoader quizLoader = new PluginLoader();                           // An object from plugin loader to load objects from classes which implement Quiz Interface
        PluginLoader questionLoader = new PluginLoader();                       // An object from plugin loader to load objects from classes which implement Question Interface
