 ...
 * @author Bingusara
 */
public class SEC_asgn_test_GUIAPP_v30 {
    ...
    public static void main(String[] args) {
        ...
        SEC_asgn_test_GUIAPP_v30 mainObj = new SEC_asgn_test_GUIAPP_v30();
        ...
        JLabel title = new JLabel("Welcome to the Quiz App v3.0");
        ...
        PluginLoader quizLoader = mainObj.givePluginLoaderObj();
        PluginLoader questionLoader = mainObj.givePluginLoaderObj();      
                        ...
                        try{
                            ...
                            while (results[2]  == 0)
                            {
                                try {
                                    ...
                                    Logger.getLogger(SEC_asgn_test_GUIAPP_v30.class.getName()).log(Level.SEVERE, null, ex);
                                }
                            }
